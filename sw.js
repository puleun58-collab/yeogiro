const APP_CACHE = 'yeogiro-app-v81';
const MAP_CACHE = 'yeogiro-map-v3';
const MAX_MAP_ENTRIES = 160;
const APP_SHELL = [
  '/',
  '/index.html',
  '/data-integrity.js?v=81',
  '/diagnostics.js?v=81',
  '/expense-logic.js?v=81',
  '/weather-logic.js?v=81',
  '/sync.js?v=81',
  '/sync-ui.js?v=81',
  '/travel-logic.js?v=81',
  '/notification-logic.js?v=81',
  '/preparation-logic.js?v=81',
  '/trip-recap-logic.js?v=81',
  '/pwa-update.js?v=81',
  '/offline.html',
