...
assert.match(source, /yeogiro-app-v23/, 'app shell cache version was advanced');
assert.match(source, /'\/sync-ui\.js\?v=23'/, 'conflict UI uses a versioned app-shell URL');
...
console.log('7 PWA cache checks passed');
